...
void PlayScene::ConstructUI() {
    ...
    UIGroup->AddNewObject(new skillImage("play/shop_coin.png","double_coin",1480,600,100,100));
    UIGroup->AddNewObject(new Timer("play/timer (1).png", 1480,600, 220,200,"super"));
